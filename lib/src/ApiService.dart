class ApiService {
  static Uri url(url) {
    Uri Server = Uri.parse("http://192.168.1.6:8000/mobile/" + url);
    return Server;
  }

  static Uri urlApi(url) {
    Uri server = Uri.parse("http://192.168.1.6:8000/api/" + url);
    return server;
  }

  static String urlGambar(url) {
    String Server = "http://192.168.1.6/kucari_web/public/mobile/uploads/" + url;
    return Server;
  }
